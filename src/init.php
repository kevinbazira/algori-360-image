 ...
 * @since 1.0.0
 */
function algori_360_image_cgb_block_assets() { // phpcs:ignore
	...
	register_block_type(
		'algori-360-image/block-algori-360-image', array(
			...
			'editor_script' => 'algori_360_image-cgb-block-js',
			// Enqueue blocks.editor.build.css in the editor only.
			'editor_style'  => 'algori_360_image-cgb-block-editor-css',
		)
	);
...
// Hook: Block assets.
add_action( 'init', 'algori_360_image_cgb_block_assets' );
